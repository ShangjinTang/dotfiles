...
augroup asyncrun
    ...
    autocmd FileType c,cpp nnoremap <silent> <C-\>4 :call AsyncRunWith("-cwd=<root> mkdir build &> /dev/null; cd build; cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=1 .. && cp compile_commands.json .. && make run")<CR>
    " Rust
